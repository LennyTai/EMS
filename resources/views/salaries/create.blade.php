...
<div class="row">
    <div class="col-sm-12">
        <div class="card">
            ...
            <hr>
                {{ Form::model($employee, ['action' => ['SalaryController@store'], 'enctype' => 'multipart/form-data']) }}
                @csrf
            <div class="row">
                {{ Form::hidden('employee_id', $salary->employee->id) }}
                <div class="form-group col-sm-3">
                    {{ Form::label('int_job_title', 'Internal Job Title', ['class' => 'required']) }}
                    {{ Form::select('int_job_title', __('message.int_job_title'), '', ['class' => 'form-control', 'placeholder' => '[Please Select]' ]) }}
                </div>
                <div class="form-group col-sm-3">
                    {{ Form::label('ext_job_title', 'External Job Title', ['class' => 'required']) }}
                    {{ Form::select('ext_job_title', __('message.ext_job_title'), '', ['class' => 'form-control', 'placeholder' => '[Please Select]' ]) }}
                </div>
                <div class="form-group col-sm-3">
                    {{ Form::label('dpt_name', 'Department', ['class' => 'required']) }}
                    {{ Form::select('dpt_name', __('message.department'), '', ['class' => 'form-control', 'placeholder' => '[Please Select]']) }}
                </div>
                <div class="form-group col-sm-3">
                    {{ Form::label('entity', 'Entity', ['class' => 'required']) }}
                    {{ Form::select('entity', __('message.entity'), '', ['class' => 'form-control', 'placeholder' => '[Please Select]']) }}
                </div>
            </div>
            <div class="row">
                <div class="form-group col-sm-3">
                ...
                <div class="form-group col-sm-3">
                    ...
                    {{ Form::select('salary_adjust', __('message.salary_adjust'), '', ['class' => 'form-control', 'placeholder' => '[Please Select]' ]) }}
                </div>
                <div class="form-group col-sm-3">
                    {{ Form::label('promotion', 'Changes') }}
                    {{ Form::select('promotion', __('message.promotion'), '', ['class' => 'form-control', 'placeholder' => '[Please Select]' ]) }}
                </div>
            </div>
            <div class="row">
                <div class="form-group col-sm-3">
                    {{ Form::label('appraisal', 'Appraisal') }}
                    {{ Form::textarea('appraisal', '', ['class' => 'form-control', 'rows' => '3']) }}
                </div>
                <div class="form-group col-sm-3">
                ...
                <div class="form-group col-sm-3">
                    ...
                    {{ Form::date('date', '', ['class' => 'form-control', 'max' => '2999-12-31']) }}
                </div>
            </div>
            <hr>
            <div class="row">
            ...
            {{ link_to(URL::route('salaries.index', $employee->id), 'Back', ['class' => 'btn btn-primary', 'style' => 'float: right']) }}
            {{ Form::close() }}
            </div>
        </div>
    </div>
